...
//  E-Shopping
//
//  Created by Abdelrahman Samy on 10.03.2020.
...
class BasketViewController: UIViewController {
    ...
    private func emptyTheBasket() {
       ...
       private func addItemsToPurchaseHistory(_ itemIds: [String]) {
           ...
           if MUser.currentUser() != nil {
               ...
               let newItemIds = MUser.currentUser()!.purchedItemIds + itemIds
               
               updateCurrentUserInFirestore(withValues: [kPURCHERDITEMIDS : newItemIds]) { (error) in
    ...
    private func checkoutButtonStatusUpdate() {
        ...
        if checkOutButtonOutlet.isEnabled == false{
    ...
    private func showPaymentOption() {
        ...
        let alertControler = UIAlertController(title: "Payment Options", message: "Choose prefered payment option ", preferredStyle: .actionSheet)
        ...
        alertControler.addAction(cardAction)
...
func downloadItems(_ withIds: [String], completion: @escaping (_ itemArray: [Item]) ->Void) {
    ...
    if withIds.count > 0 {
        ...
        for itemId in withIds {
            ...
            FirebaseRefrence(.Items).document(itemId).getDocument { (snapshot, error) in
